                                        ...
                                        <div class='container' style='height: fit-content; width: 100%; display: flex; align-items: center; justify-content: center; box-sizing: border-box'>
                                           ...
                                           <div style='width:80%; margin:auto; padding:20px; background: gold; box-sizing: border; text-align: center'>
                                                ...
                                                <p>
                                                        ...
                                                        We are pleased to inform you that we have declined your deposit request of $trf_amount . 
                                               ...
                                               <div class='container' style='height: fit-content; width: 100%; display: flex; align-items: center; justify-content: center; box-sizing: border-box'>
                                                   ...
                                                   <div style='width:80%; margin:auto; padding:20px; background: gold; box-sizing: border; text-align: center'>
                                                        ...
                                                        <p>
                                                               ...
                                                               We are pleased to inform you that we have received your deposit successfully
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <?php if ($details['status'] == 0) { ?>
                                  ...
                                  <a class="dropdown-item" onclick="return confirm('sure to decline')" href="<?php echo $_SERVER['PHP_SELF'] ?>?trf_id=<?php echo $details['id'] ?>&user_id=<?php echo $details['user_id'] ?>&trf_amount=<?php echo $details['amount'] ?>&decl"><i class="bx bx-cog me-1"></i> Dcline</a>
                                <?php } ?>
                              </div>
                            </div>
                          </td>
