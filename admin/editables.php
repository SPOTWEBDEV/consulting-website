...
if(isset($_POST['total_deposit'])){
  ...
  $sql = mysqli_query($con,"UPDATE users set total_deposit = total_deposit + '$amount' where id = '$id'");
   if($sql){
    echo "<script> Swal.fire('Done','You have successfully added total deposit of this user','success') </script>";
   }
}
if(isset($_POST['total_withdrawal'])){
  ...
  $sql = mysqli_query($con,"UPDATE users set total_withdrawal = total_withdrawal + '$amount' where id = '$id'");
   if($sql){
    echo "<script> Swal.fire('Done','You have successfully added total withdrawal of this user','success') </script>";
   }
}
...
if(isset($_POST['ref_balance'])){
  ...
  $sql = mysqli_query($con,"UPDATE users set referral_balance = referral_balance + '$amount' where id = '$id'");
   if($sql){
    echo "<script> Swal.fire('Done','You have successfully added referral balance of this user','success') </script>";
   }
}
if(isset($_POST['referral'])){
  ...
  $sql = mysqli_query($con,"UPDATE users set referral = referral + '$amount' where id = '$id'");
   if($sql){
    echo "<script> Swal.fire('Done','You have successfully added no of referral of this user','success') </script>";
   }
}
if(isset($_POST['add_commission'])){
  ...
  $sql = mysqli_query($con,"UPDATE users set trading_commission = trading_commission + '$amount' where id = '$id'");
   if($sql){
    echo "<script> Swal.fire('Done','You have successfully added trading commission of this user','success') </script>";
   }
}
...
if(isset($_POST['pend_investment'])){
  ...
  $sql = mysqli_query($con,"UPDATE users set pending_investment = pending_investment + '$amount' where id = '$id'");
   if($sql){
    echo "<script> Swal.fire('Done','You have successfully pended some investment for this user','success') </script>";
   }
}
...
if(isset($_POST['promo_won'])){
  ...
  $sql = mysqli_query($con,"UPDATE users set promo_won = promo_won + '$amount' where id = '$id'");
   if($sql){
    echo "<script> Swal.fire('Done','You have successfully some promo to this user','success') </script>";
   }
}
...
if(isset($_POST['add_warning'])){
  ...
  if($sql){
    echo "<script> Swal.fire('Done','You have successfully added account warning to this user,','success') </script>";
  }
}
...
if(isset($_POST['restrict'])){
    ...
    if($exe){
        echo "<script> Swal.fire('Done','You have successfully restricted this account from withdrawing','success') </script>";
    }
}
