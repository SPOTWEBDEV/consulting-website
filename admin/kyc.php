                              ...
                              Swal.fire('Failed','Error adding {$add} to this investment','error')
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $details['drivinglincense'] ?></td>
                                                        ...
                                                        if ($details['status'] == 'pending') { ?>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" onclick="return confirm('Are you sure you want to approved this user')" href="./kyc.php?rejected=<?php echo $details['id'] ?>&user=<?php echo $details['user_id'] ?>"><i class="bx bx-cog me-1"></i>Reject</a>
                                                                    <a class="dropdown-item" onclick="return confirm('Are you sure you want to reject this user')" href="./kyc.php?approved=<?php echo $details['id'] ?>&user=<?php echo $details['user_id'] ?>"><i class="bx bx-cog me-1"></i>Approved</a>
