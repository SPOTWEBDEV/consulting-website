                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    if (isset($_GET['decl'])) {
                      ...
                      $decline = mysqli_query($con, "UPDATE `withdrawals` SET `status` = 2 WHERE `id` = '$trf_id'");
                        $r_info_row = mysqli_query($con, "SELECT * FROM `users` WHERE `id` = '$trf_id'");
                                               ...
                                               <div class='container' style='height: fit-content; width: 100%; display: flex; align-items: center; justify-content: center; box-sizing: border-box'>
                                                   ...
                                                   <div style='width:80%; margin:auto; padding:20px; background: gold; box-sizing: border; text-align: center'>
                                                        ...
                                                        <p>
                                                            ...
                                                            We are pleased to inform you that your withdrawal request of $$trf_amount 
                                                            has been thoroughly reviewed and declined. Should you have any further 
                                                            inquiries or require assistance, please do not hesitate to contact our support team. <br><br>
                                                ...
                                                <div class='container' style='height: fit-content; width: 100%; display: flex; align-items: center; justify-content: center; box-sizing: border-box'>
                                                   ...
                                                   <div style='width:80%; margin:auto; padding:20px; background: gold; box-sizing: border; text-align: center'>
                                                        ...
                                                        <p>
                                                            ...
                                                            We are pleased to inform you that your withdrawal request has been thoroughly
                                                            ...
                                                            do not hesitate to contact our support team. <br><br>
