                                    ...
                                    <div class="row">
                                             <div class="col-lg-4 col-md-7">
                                                      <div class="footer-widget">
                                                               ...
                                                               <!-- <a href="index.html"><img src="<?php echo $domain ?>assets/img/logo/w_logo.jpg" alt=""></> -->
                                                               <img style="height:70px !important"
                                                                        src="<?php echo $domain ?>logo.png" alt="Logo">


                                                               <div class="footer-content">
                                                                        <p>In addition to his academic training and
                                                                                 leadership, he served as Senior Tax
                                                                                 Specialist with the Florida Department
                                                                                 of Revenue for thirteen years,
                                                                                 specializing in tax laws, auditing,
                                                                                 sales & use tax, intangible tax,
                                                                                 corporate tax, local option tax, and
                                                      ...
                                                      <div class="footer-widget">
                                                               ...
                                                               <div class="footer-link">
                                                                        <ul class="list-wrap">
                                                                                 ...
                                                                                 <li><a href="<?php echo $domain ?>service/">Service</a>
                                                                                 </li>
                                                                                 <li><a href="<?php echo $domain ?>portfolio/">Portfolio</a>
                                                                                 </li>
                                                                                 <li><a href="<?php echo $domain ?>contact/">Contact</a>
                                                                                 </li>
                                                                        </ul>
                                                               </div>
                                                      </div>
                                                               ...
                                                               <div class="footer-info">
                                                                        <ul class="list-wrap">
                                                                                 ...
                                                                                 <li>
                                                                                          ...
                                                                                          <div class="content">
                                                                                                   <a
                                                                                                            href="tel:<?php echo $sitenumber ?>"><?php echo $sitenumber ?></a>
                                                                                          </div>
                                                                                 </li>
                                                                                 <li>
                                                                                          <div class="icon">
