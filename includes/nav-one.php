            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="header-top-left">
                        <ul class="list-wrap">
                            <li><i class="fas fa-map-marker-alt"></i><?php echo $siteaddress ?></li> <!-- Changed to Font Awesome -->
                            <li><i class="fas fa-envelope"></i><a href="mailto:<?php echo $siteemail ?>"><?php echo $siteemail ?></a></li> <!-- Changed to Font Awesome -->
                        </ul>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="header-top-right">
                        <div class="header-contact">
                            <a href="tel:0123456789"><i class="fas fa-phone-alt"></i><?php echo $sitenumber ?></a> <!-- Changed to Font Awesome -->
                        </div>
                        ...
                        <nav class="menu-nav">
                            ...
                            <div class="header-action d-none d-md-block">
                                <ul class="list-wrap">
                                    ...
                                    <li class="header-btn"><a href="<?php echo $domain ?>login/" class="btn btn-two">Book-Now</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="search-form">
                            <form action="#">
                                ...
                                <button class="search-btn"><i class="fas fa-search"></i></button> <!-- Changed to Font Awesome -->
                            </form>
                        </div>
                    </div>
                </div>
