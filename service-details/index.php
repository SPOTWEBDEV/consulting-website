                    ...
                    <div class="col-71 order-0 order-lg-2">
                        <div class="services-details-wrap">
                            <div class="services-details-content">
                                ...
                                <!-- <div class="speed-optimized-wrap">
                    ...
                    <div class="col-29">
                        <aside class="services-sidebar">
                            ...
                            <div class="services-widget services-sidebar-contact">
                                ...
                                <a href="tel:<?php echo $sitenumber ?>"><i class="flaticon-phone-call"></i> <?php echo $sitenumber ?></a>
                            </div>
                            <div class="services-widget">
                                ...
                                <div class="services-brochure-wrap">
                                    ...
                                    <a href="<?php echo $domain ?>assets/img/services/services_details01.jpg" target="_blank" download class="download-btn"><i class="far fa-file-pdf"></i>PDF. Download</a>
                                    <a href="<?php echo $domain ?>assets/img/services/services_details01.jpg" target="_blank" download class="download-btn"><i class="far fa-file-alt"></i>DOC. Download</a>
                                </div>
                            </div>
    ...
    <script type="module">
        ...
        const loadingSection = () => {
            ...
            for (let i = 0; i < services.length; i++) {
                ...
                const html = `<li class="active"><a href="<?php echo $domain ?>service-details/?index=${id}">${name} <i class="fas fa-arrow-right"></i></a></li>`
